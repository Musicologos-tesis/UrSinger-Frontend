...
@Component({
  selector: 'app-mix-coordination-exercise',
  standalone: true,
  imports: [CommonModule, GenericExerciseComponent],
  templateUrl: './mix-coordination-exercise.component.html',
  styleUrl: './mix-coordination-exercise.component.scss',
})
export class MixCoordinationExerciseComponent {
