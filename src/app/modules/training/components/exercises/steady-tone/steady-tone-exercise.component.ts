...
@Component({
  selector: 'app-steady-tone-training-exercise',
  standalone: true,
  imports: [CommonModule, GenericExerciseComponent],
  templateUrl: './steady-tone-exercise.component.html',
  styleUrl: './steady-tone-exercise.component.scss',
})
export class SteadyToneExerciseComponent {
