...
@Component({
  selector: 'app-dynamic-wave-exercise',
  standalone: true,
  imports: [CommonModule, GenericExerciseComponent],
  templateUrl: './dynamic-wave-exercise.component.html',
  styleUrl: './dynamic-wave-exercise.component.scss',
})
export class DynamicWaveExerciseComponent {
