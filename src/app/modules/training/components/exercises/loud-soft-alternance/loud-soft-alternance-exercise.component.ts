...
@Component({
  selector: 'app-loud-soft-alternance-exercise',
  standalone: true,
  imports: [CommonModule, GenericExerciseComponent],
  templateUrl: './loud-soft-alternance-exercise.component.html',
  styleUrl: './loud-soft-alternance-exercise.component.scss',
})
export class LoudSoftAlternanceExerciseComponent {
