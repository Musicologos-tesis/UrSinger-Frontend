...
@Component({
  selector: 'app-pitch-steps-exercise',
  standalone: true,
  imports: [CommonModule, GenericExerciseComponent],
  templateUrl: './pitch-steps-exercise.component.html',
  styleUrl: './pitch-steps-exercise.component.scss',
})
export class PitchStepsExerciseComponent {
