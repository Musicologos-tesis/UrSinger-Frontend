...
@Component({
  selector: 'app-controlled-vibrato-exercise',
  standalone: true,
  imports: [CommonModule, GenericExerciseComponent],
  templateUrl: './controlled-vibrato-exercise.component.html',
  styleUrl: './controlled-vibrato-exercise.component.scss',
})
export class ControlledVibratoExerciseComponent {
