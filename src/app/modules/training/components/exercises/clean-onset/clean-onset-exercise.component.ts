...
@Component({
  selector: 'app-clean-onset-exercise',
  standalone: true,
  imports: [CommonModule, GenericExerciseComponent],
  templateUrl: './clean-onset-exercise.component.html',
  styleUrl: './clean-onset-exercise.component.scss',
})
export class CleanOnsetExerciseComponent {
