...
@Component({
  selector: 'app-step-expansion-exercise',
  standalone: true,
  imports: [CommonModule, GenericExerciseComponent],
  templateUrl: './step-expansion-exercise.component.html',
  styleUrl: './step-expansion-exercise.component.scss',
})
export class StepExpansionExerciseComponent {
