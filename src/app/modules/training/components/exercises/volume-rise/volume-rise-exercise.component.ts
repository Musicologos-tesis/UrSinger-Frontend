...
@Component({
  selector: 'app-volume-rise-exercise',
  standalone: true,
  imports: [CommonModule, GenericExerciseComponent],
  templateUrl: './volume-rise-exercise.component.html',
  styleUrl: './volume-rise-exercise.component.scss',
})
export class VolumeRiseExerciseComponent {
