...
@Component({
  selector: 'app-pitch-target-exercise',
  standalone: true,
  imports: [CommonModule, GenericExerciseComponent],
  templateUrl: './pitch-target-exercise.component.html',
  styleUrl: './pitch-target-exercise.component.scss',
})
export class PitchTargetExerciseComponent {
