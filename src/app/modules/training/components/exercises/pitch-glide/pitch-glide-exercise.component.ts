...
@Component({
  selector: 'app-pitch-glide-exercise',
  standalone: true,
  imports: [CommonModule, GenericExerciseComponent],
  templateUrl: './pitch-glide-exercise.component.html',
  styleUrl: './pitch-glide-exercise.component.scss',
})
export class PitchGlideExerciseComponent {
