...
@Component({
  selector: 'app-vocal-glide-exercise',
  standalone: true,
  imports: [CommonModule, GenericExerciseComponent],
  templateUrl: './vocal-glide-exercise.component.html',
  styleUrl: './vocal-glide-exercise.component.scss',
})
export class VocalGlideExerciseComponent {
